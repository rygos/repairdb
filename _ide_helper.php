 ...
 * Generated for Laravel 5.7.25 on 2019-02-07 19:14:21.
 *
...
namespace Inani\Larapoll { 
    ...
    class PollWriterFacade {
        ...
        {
            return \Inani\Larapoll\Helpers\PollWriter::draw($poll_id, $voter);
        }
         ...
         * @static 
         */ 
        public static function drawResult($poll)
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawResult($poll);
        }
         ...
         * @static 
         */ 
        public static function drawResultHeader($question)
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawResultHeader($question);
        }
         ...
         * @static 
         */ 
        public static function drawResultOption($result, $total)
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawResultOption($result, $total);
        }
        
        /**
         * Drawing the poll for checkbox case
         *
         * @param \Inani\Larapoll\Helpers\Poll $poll
         * @static 
         */ 
        public static function drawCheckbox($poll)
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawCheckbox($poll);
        }
         ...
         * @static 
         */ 
        public static function drawOptionCheckbox($id, $name)
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawOptionCheckbox($id, $name);
        }
         ...
         * @static 
         */ 
        public static function drawRadio($poll)
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawRadio($poll);
        }
        ...
        {
            return \Inani\Larapoll\Helpers\PollWriter::showFeedBack();
        }
        ...
        {
            return \Inani\Larapoll\Helpers\PollWriter::startForm($id);
        }
        ...
        {
            return \Inani\Larapoll\Helpers\PollWriter::endForm();
        }
        ...
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawStartHeaderPanel();
        }
        ...
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawEndHeaderPanel();
        }
        ...
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawHeader($question);
        }
        ...
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawStartOptionsPanel();
        }
        ...
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawEndOptionsPanel();
        }
        ...
        {
            return \Inani\Larapoll\Helpers\PollWriter::drawOption($id, $name);
        }
...
namespace  { 
    ...
    class PollWriter extends \Inani\Larapoll\PollWriterFacade {}
