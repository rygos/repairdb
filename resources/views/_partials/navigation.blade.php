<ul>
    ...
    @if(Auth::check() and Auth::user()->access_stats == 1)
    <li><a href="{{ action('StatsController@index') }}">Stats</a></li>
    @endif

    @if(Auth::check() and Auth::user()->access_xcharge == 1)
    ...
    @if(Auth::check() and Auth::user()->access_doa == 1)
        <li><a href="{{ action('DOAController@index') }}">DOA</a></li>
    @endif

    @if(Auth::check() and Auth::user()->access_overtime == 1)
